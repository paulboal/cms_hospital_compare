DROP TABLE IF EXISTS hvbp_hcahps_10_28_2015;
CREATE EXTERNAL TABLE hvbp_hcahps_10_28_2015 (
...
junk string) ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde' STORED AS TEXTFILE LOCATION "/tmp/cms_hospital_compare/current/hvbp_hcahps_10_28_2015" TBLPROPERTIES ("skip.header.line.count"="1"); 
